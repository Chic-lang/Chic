...
@extern("C") @export("chic_rt_f32_rem") public static float chic_rt_f32_rem(float lhs, float rhs) {
    return fmodf(lhs, rhs);
}
@extern("C") @export("chic_rt_f64_rem") public static double chic_rt_f64_rem(double lhs, double rhs) {
    return fmod(lhs, rhs);
}
