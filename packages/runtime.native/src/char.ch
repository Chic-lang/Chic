...
@extern("C") @export("chic_rt_char_is_scalar") public static int chic_rt_char_is_scalar(ushort value) {
    return IsScalar(value) ?1 : 0;
}
@extern("C") @export("chic_rt_char_is_digit") public static int chic_rt_char_is_digit(ushort value) {
    if (!IsScalar (value))
    {
        return - 1;
    }
...
@extern("C") @export("chic_rt_char_is_letter") public static int chic_rt_char_is_letter(ushort value) {
    if (!IsScalar (value))
    {
        return - 1;
    }
...
@extern("C") @export("chic_rt_char_is_whitespace") public static int chic_rt_char_is_whitespace(ushort value) {
    if (!IsScalar (value))
    {
        return - 1;
    }
    ...
    @extern("C") @export("chic_rt_char_to_upper") public static ulong chic_rt_char_to_upper(ushort value) {
        if (!IsScalar (value))
        {
    ...
    @extern("C") @export("chic_rt_char_to_lower") public static ulong chic_rt_char_to_lower(ushort value) {
        if (!IsScalar (value))
        {
            return Pack(CharError.InvalidScalar, 0);
        }
    ...
    @extern("C") @export("chic_rt_char_from_codepoint") public static ulong chic_rt_char_from_codepoint(uint value) {
        if (!IsScalar (value))
        {
            return Pack(CharError.InvalidScalar, 0);
        }
    ...
    @extern("C") @export("chic_rt_char_status") public static int chic_rt_char_status(ulong packed) {
        return(int)(packed >> 32);
    }
    @extern("C") @export("chic_rt_char_value") public static ushort chic_rt_char_value(ulong packed) {
