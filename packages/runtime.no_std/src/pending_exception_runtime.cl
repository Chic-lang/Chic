namespace Std.Runtime.NoStd
{
    public static class PendingExceptionRuntime
    {
        ...
        @export("chic_rt_throw") public static void ThrowPending(i64 payload, i64 typeId) {
            _has_pending = true;
        ...
        @export("chic_rt_clear_pending_exception") public static void ClearPendingException() {
            _has_pending = false;
