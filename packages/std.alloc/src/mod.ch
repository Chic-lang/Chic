...
@repr(c) public struct AllocatorVTable
{
    ...
    public static AllocatorVTable With(* mut @expose_address byte context, fn @extern("C")(* mut @expose_address byte, usize,
    usize) -> ValueMutPtr alloc, fn @extern("C")(* mut @expose_address byte, usize, usize) -> ValueMutPtr allocZeroed, fn @extern("C")(* mut @expose_address byte,
    ValueMutPtr, usize, usize, usize) -> ValueMutPtr realloc, fn @extern("C")(* mut @expose_address byte, ValueMutPtr) -> void free) {
...
@extern("C") private static ValueMutPtr ReallocStub(* mut @expose_address byte context, ValueMutPtr current, usize oldSize,
