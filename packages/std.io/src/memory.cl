...
import Std.Numeric;
import Std.Span;
/// <summary>Represents a contiguous block of memory with span access.</summary>
public struct Memory <T >
{
    private T[] ?_array;
    private int _start;
    private int _length;
    /// <summary>Initializes a memory view over the entire array.</summary>
    ...
    /// <summary>Initializes a memory view over a portion of the array.</summary>
    ...
    /// <summary>Gets a span that represents the same memory.</summary>
    public Span <T >Span {
        get {
            var array = _array;
            if (array == null)
            ...
            var span = Span <T >.FromArray(ref array);
