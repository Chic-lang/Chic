...
impl<'a> Executor<'a> {
    pub(super) fn read_i128(&self, ptr: u32) -> Result<i128, WasmExecutionError> {
    ...
    pub(super) fn write_i128(&mut self, ptr: u32, value: i128) -> Result<(), WasmExecutionError> {
    ...
    pub(super) fn read_str_ptr(&self, ptr: u32) -> Result<(u32, u32), WasmExecutionError> {
    ...
    pub(super) fn read_value_ptr(&self, ptr: u32) -> Result<(u32, u32, u32), WasmExecutionError> {
        let stride = self.ptr_stride();
        let data_ptr = self.read_u32(ptr)?;
    ...
    pub(super) fn read_span_ptr(
        &self,
        ptr: u32,
    ) -> Result<(u32, u32, u32, u32), WasmExecutionError> {
        let stride = self.ptr_stride();
    ...
    pub(super) fn ptr_stride(&self) -> u32 {
